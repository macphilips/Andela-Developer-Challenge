...
describe('Account API test', () => {
  ...
  describe('User management test', () => {
    describe('POST /api/v1/account/register create new user', () => {
      ...
      it('it should not POST a user when provided with invalid email or password ', () => chai.request(app)
      ...
      it('it should not POST a user when a user with given email already exists', () => userRepository.save({
        firstName: 'John', lastName: 'Doe', password: 'topsecret', email: 'example@local',
      })
    ...
    describe('GET /api/v1/account/me Get User', () => {
      beforeEach(() => userRepository.clear());
      it('it should not allow access to resource when authentication is not provided', () => chai.request(app)
      ...
      it('it should not allow access to resource when provided with an invalid token', () => userRepository.save({
